...
DATAS = 'ADE20K' # 'pascalvoc'
EPS = 0.0471 #0.0157, 0.0314, 0.0471, 0.0627
ITERR = "SEGMENTER_rob_init" #, #"S_mod"
ATTACK = 'apgd-larg-eps'
n_it = 300
strr = [
f"{ATTACK}_mask-ce-avg_{ITERR}_mod_{EPS}_n_it_{n_it}_{DATAS}_vit_small_patch16_224_SD_225_MAX.pt", 
f"{ATTACK}_segpgd-loss_{ITERR}_mod_{EPS}_n_it_{n_it}_{DATAS}_vit_small_patch16_224_SD_225_MAX.pt", 
f"{ATTACK}_js-avg_{ITERR}_mod_{EPS}_n_it_{n_it}_{DATAS}_vit_small_patch16_224_SD_225_MAX.pt", 
f"{ATTACK}_mask-norm-corrlog-avg_{ITERR}_mod_{EPS}_n_it_{n_it}_{DATAS}_vit_small_patch16_224_SD_225_MAX.pt"
]
    ...
    for j in range(1):
        ...
        for i, vals in enumerate(data_loder):
            ...
            if False:
                ...
                print(pred.shape, target.shape) #, out.shape)
