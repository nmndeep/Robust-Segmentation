...
# print(train_stats)
t1_rob = [73.8, 68.0, 64.7, 63.1, 62.4, 62.2]
t1_clean = [0.8, 0.0, 0.0, 0.0, 0.0]
...
plt.plot(xx1, train_stats[0], linewidth=1.5, color = my_cmap2(18), marker='o', label="PGD-2-AT")
# plt.plot(xx1, train_stats[1], linewidth=1.5, color = my_cmap2(0), label="Clean")

# plt.annotate('lr-peak', xy=(xx2[65], train_stats[0][65]+.1))
plt.title("Mask-Margin-APGD robust accuracy at $\ell_\infty$ = 8/255 v.s the number of iterations")
...
plt.xticks(xx1)
plt.ylabel("Robust ACC (%)", fontsize=12)
